...
class UserInput extends Component{
    ...
    **************/
    ...
    onChange(e, item ){
        ...
        this.setState({ name: lbl },()=> this.senddata())
    ...
    updatePossibleLabels(){
        ...
        if (this.props.possibleLabels.length > 0){
            possibleNames = this.props.possibleLabels.map(e => {
    ...
    confirmLabel(){
        ...
        this.annoLabelUpdate(this.state.name)
        ...
        return (
            <Ref innerRef={this.inputRef}>
                    <Dropdown
                        ...
                        closeOnChange
                        icon="search"
                        options={this.state.possibleNames}
    ...
    renderLabelInfo(){
        ...
        if (this.state.name.length > 0){
            lbl = this.props.possibleLabels.find(e => {
                return this.state.name[this.state.name.length-1] === e.id
            })
        }
